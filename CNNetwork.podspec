#
#  Be sure to run `pod spec lint CNNetwork.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    Simple request base on Alamofire & RxSwift
                   DESC
  ...
  # Or just: s.author    = "邓锋"
  # s.authors            = { "邓锋" => "704292743@qq.com" }
  # s.social_media_url   = "http://twitter.com/邓锋"
